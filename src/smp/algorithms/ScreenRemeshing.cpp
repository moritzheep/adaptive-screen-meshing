...
namespace pmp 
{
    ...
    ScreenRemeshing<Projection>::ScreenRemeshing(SurfaceMesh& mesh, const cv::Mat& normals, const cv::Mat& mask, Projection projection) : mesh_(mesh), geo_(mesh_, normals, mask, projection)
    {
